...
\begin{adjustwidth}{-2.2cm}{-2.2cm}
    ...
    \eosec
    \ressection{Research}
    I study the subfield of machine learning called reinforcement learning with Professor Soumya Ray. I focus on using continuous learning techniques to solve simulated control tasks. I run experiments on CentOS servers using Python with machine learning and scientific computing packages.
    \eosec
